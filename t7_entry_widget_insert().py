...
entry.insert(0, "Real Python") # insert method preloads the widget with text and if entry already contains
# some text, then it will insert the new text at the specified index and shift all existing text to the right
